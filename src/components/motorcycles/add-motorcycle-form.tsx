...
const formSchema = z.object({
  ...
  status: z.enum(['active', 'inadimplente', 'recolhida', 'relocada', 'renegociado', 'manutencao', 'alugada', 'indisponivel_rastreador', 'indisponivel_emplacamento', 'furto_roubo']).optional(),
