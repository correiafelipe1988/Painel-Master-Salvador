...
const chartConfig = {
  count: {
    ...
    color: "hsl(var(--chart-5))", // Using chart-5 for a new color
  },
} satisfies ChartConfig;

export function TotalRentalsVolumeChart({ data }: { data: ChartDataPoint[] | null }) {
        ...
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 5, right: 10, left: -25, bottom: 5 }}>
            ...
            <YAxis
              ...
              tickLine={false}
              tickCount={5}
              domain={[0, 'dataMax + 2']} // Adjusted domain slightly
              allowDecimals={false}
            />
            <Tooltip
